...
//                       className="w-full flex items-center gap-3 px-4 py-3 text-sm text-teal-600  bg-teal-50 dark:bg-teal-900/30 transition-all duration-200 group rounded-lg mx-2"
//                     >
...
const Header = ({ mobileMenuTrigger }: HeaderProps) => {
  ...
  const getCurrentPath = (path: string) => {
    ...
    return pathNames[currentPath] || "Tableau de bord";
  };
